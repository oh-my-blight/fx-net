...
### Fx.Net.Generators.Sample

A project that references source generators. Note the parameters of `ProjectReference`
in [Fx.Net.Generators.Sample.csproj](../Fx.Net.Generators.Sample/Fx.Net.Generators.Sample.csproj), they make sure that
the project is referenced as a set of source generators.

### Fx.Net.Generators.Tests
